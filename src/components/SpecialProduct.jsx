      ...
      <div className="special-product-card">
        <div className="d-flex justify-content-between">
          ...
          <div className="special-product-content">
            ...
            <h6 className="title">Samsung Galaxy 10note pro</h6>
            <ReactStars
    count={5} size={24} value={3} edit={false}
    activeColor="#ffd700"
  />
  <p className="price"><span className="red-p">₹7000 </span> &nbsp;<strike>₹8000</strike></p>
